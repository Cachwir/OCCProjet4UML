...
CREATE TABLE `orders_dishes` (
  ...
  `tva` decimal(6,2) COLLATE utf8_unicode_ci
...
INSERT INTO `orders_dishes` (`id`, `quantity`, `dish_id`, `order_id`, `price_ht`, `price_ttc`, `tva`) VALUES (NULL, '1', '1', '1', 7.20, 9.36, 30), (NULL, '1', '4', '1', 4.50, 5.85, 30);